...
macro(mmdeploy_add_net NAME)
    if (MMDEPLOY_DYNAMIC_BACKEND)
        mmdeploy_add_library(${NAME} SHARED EXCLUDE ${ARGN})
#        target_link_libraries(${PROJECT_NAME} PRIVATE mmdeploy)
        target_link_libraries(${PROJECT_NAME} PRIVATE mmdeploy_core)
#        target_link_options(${NAME} PRIVATE /ALTERNATENAME:_mmdeploy_test_log=_default_mmdeploy_test_log)
